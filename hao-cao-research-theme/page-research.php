										...
										<div class="research-theme-primary">
											<div class="research-theme-copy">
												...
												<p>
													...
													dynamics. The group combines spacecraft gravity fields, magnetic constraints, and geophysical
													modeling to infer how atmospheric jets extend below cloud tops, how conducting fluids move
													inside giant planets, and what those hidden motions reveal about planetary structure and
													evolution.
												</p>
											</div>
										</div>
										...
										<div class="research-theme-primary">
											<div class="research-theme-copy">
												...
												<p>
													...
													planets. The group studies magnetic-field geometry and time variation from missions such as
													Juno and Cassini to understand planetary dynamos, secular variation, and the electrically
										...
										<div class="research-theme-primary">
											<div class="research-theme-copy">
												...
												<p>
													...
													environments. The group uses electromagnetic responses to study subsurface oceans, ice shells,
													and the plasma environments around moons such as Europa, Ganymede, and Callisto, linking
													interior structure with the surrounding magnetospheric system.
												</p>
											</div>
										</div>
										<details class="research-theme-links" aria-label="Related content">
										...
										<div class="research-theme-primary">
											<div class="research-theme-copy">
												...
												<p>
													...
													group develops miniaturized, low-power fluxgate magnetometer systems for surface observatories,
													using sustained magnetic records to investigate electrical structure, thermal state, and
									...
									<article id="space-weather" class="research-theme">
										<div class="research-theme-primary">
											<div class="research-theme-copy">
												<h3>Space Weather</h3>
												<p>
													Fluxgate magnetometers help measure Earth&apos;s near-space response to solar-wind forcing. Through
													the TRACERS mission and related instrument work, the group builds and applies magnetic-field
													measurements to study reconnection, polar cusp dynamics, and the way solar-wind energy enters
