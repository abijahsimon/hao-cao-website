				...
				<div class="wrapper research-page-wrapper">
					...
					<div class="container">
						<article id="main" class="research-page">
							...
							<section class="research-theme-list" aria-label="Research areas with related links and videos">
								<article class="research-theme">
									<div class="research-theme-primary">
										...
										<div class="research-theme-copy">
											<span class="research-theme-label">Hao Cao Group Work</span>
									...
									<details class="research-theme-links">
										<summary>Related context links and videos</summary>
										<ul class="research-source-list">
											<li>
												<span class="research-source-type">Hao Video</span>
											...
											<li>
												<span class="research-source-type">Mission</span>
								...
								<article class="research-theme">
									...
									<details class="research-theme-links">
										...
										<ul class="research-source-list">
											...
											<li>
												<span class="research-source-type">UCLA</span>
