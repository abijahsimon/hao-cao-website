...
<html>
	<head>
		<title>Team | Hao Cao</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no" />
		<meta
			name="description"
			content="Team page for Hao Cao's UCLA research group, including current members, alumni, and mentoring context."
		/>
		...
		<div id="page-wrapper">
					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								...
								<li class="active"><a href="<?php echo esc_url(hao_cao_research_page_url('team')); ?>">Team</a></li>
			...
			<!-- Main -->
				<div class="wrapper">
					...
					<div class="container">
						<article id="main" class="team-page simple-content-page">
							<header>
								<h2>Team</h2>
							</header>
							...
							<figure class="team-photo">
								...
								<figcaption>
									Hao research team 2025. Top row from left to right: Paula Wulff, Donglai Ma, Nayaab Singh,
									Kyle Webster. Bottom row from left to right: Wenyu Zhang, Hao Cao, Chengzhi Mao, Miranda Chang.
								</figcaption>
							</figure>
							...
							<section class="team-roster-section">
								...
								<ul class="simple-list">
									<li>Nayaab Singh (Class of 2025)</li>
								</ul>
							</section>

							<section class="team-roster-section">
								<h3>Graduate Student Researchers</h3>
								<ul class="simple-list">
									<li>Chengzhi Mao (2025 &ndash; present)</li>
									<li>Miranda Chang (2023 &ndash; present)</li>
									<li>Wenyu Zhang (2023 &ndash; present)</li>
								</ul>
							</section>
							...
							<section class="team-roster-section">
								...
								<ul class="simple-list">
									<li>Dr. Paula Wulff (2024 &ndash; present)</li>
								</ul>
							</section>

							<section class="team-roster-section">
								<h3>Alum</h3>
								<h4>Graduate Student Researchers</h4>
								<ul class="simple-list">
									<li>Kyle Webster (2023 &ndash; 2026)</li>
								</ul>
								<h4>Undergraduate Student Researchers</h4>
								<ul class="simple-list">
									<li>Ian Fu (2022 &ndash; 2024, Class of 2024, now a graduate student at Stanford)</li>
									<li>Runa Indrei (2023 &ndash; 2024, Class of 2024, now a graduate student at USC)</li>
								</ul>
								<h4>Assistant Researcher</h4>
								<ul class="simple-list">
