					...
					<section id="banner">
						<header>
							<p class="homepage-intro-copy">
								<strong>Hao Cao studies planetary interiors and the space environment through data analysis, numerical simulations, and instrument innovation.</strong>
								His group combines spacecraft magnetic and gravitational measurements with theory, numerical modeling, and
							...
							<div class="container">
								<div class="research-summary-layout">
									<header class="special">
										...
										<p>
											How do planets and moons work beneath their visible surfaces? Physical signals measured by
											spacecraft and instruments can infer what cannot be observed directly.
										</p>
